...
// Blit to screen
bool ModuleRender::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float speed, bool flip, bool useCamera)
{
	bool ret = true;
	...
	if (SDL_RenderCopyEx(renderer, texture, section, &dstRect, 0, NULL, flip? SDL_FLIP_HORIZONTAL : SDL_FLIP_NONE) != 0)
	{
