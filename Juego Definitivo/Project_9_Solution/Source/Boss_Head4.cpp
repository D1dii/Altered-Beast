...
Boss_Head4::Boss_Head4(int x, int y) : Enemy(x, y) {
...
void Boss_Head4::Update() {
	...
	case Boss_Head4::state::LAUNCH:
		...
		break;
	case Boss_Head4::state::ATTACK:
		currentAnim = &attackAnim;
		attackAnim.Update();
		attackPath.Update();
		position = spawnPos + attackPath.GetRelativePosition();
		break;
	case Boss_Head4::state::DEATH:
...
void Boss_Head4::OnCollision(Collider* col) {

}

void Boss_Head4::SetToDelete() {
