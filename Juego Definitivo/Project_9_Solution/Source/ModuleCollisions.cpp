...
ModuleCollisions::ModuleCollisions(bool startEnabled) : Module(startEnabled)
{
	...
	matrix[Collider::Type::WALL][Collider::Type::SCREEN_RIGHT] = false;
	matrix[Collider::Type::WALL][Collider::Type::ITEM] = false;
	matrix[Collider::Type::WALL][Collider::Type::COLUMNS] = false;
	...
	matrix[Collider::Type::PLAYER][Collider::Type::COLUMNS] = true;
	...
	matrix[Collider::Type::ENEMY][Collider::Type::COLUMNS] = true;
	...
	matrix[Collider::Type::ENEMY_SHOT][Collider::Type::COLUMNS] = false;
	...
	matrix[Collider::Type::SCREEN_LEFT][Collider::Type::COLUMNS] = false;
	...
	matrix[Collider::Type::SCREEN_RIGHT][Collider::Type::COLUMNS] = false;
	...
	matrix[Collider::Type::ITEM][Collider::Type::COLUMNS] = false;

	matrix[Collider::Type::COLUMNS][Collider::Type::WALL] = false;
	matrix[Collider::Type::COLUMNS][Collider::Type::PLAYER] = true;
	matrix[Collider::Type::COLUMNS][Collider::Type::ENEMY] = true;
	matrix[Collider::Type::COLUMNS][Collider::Type::PLAYER_ATTACK] = false;
	matrix[Collider::Type::COLUMNS][Collider::Type::ENEMY_SHOT] = false;
	matrix[Collider::Type::COLUMNS][Collider::Type::SCREEN_LEFT] = false;
	matrix[Collider::Type::COLUMNS][Collider::Type::SCREEN_RIGHT] = false;
	matrix[Collider::Type::COLUMNS][Collider::Type::ITEM] = false;
}
...
void ModuleCollisions::DebugDraw()
{
	...
	for(uint i = 0; i < MAX_COLLIDERS; ++i)
	{
		...
		switch(colliders[i]->type)
		{
			...
			break;
			case Collider::Type::COLUMNS: //White blue
				App->render->DrawQuad(colliders[i]->rect, 0, 130, 255, alpha);
				break;
		}
	}
}
