...
Boss_Head2::Boss_Head2(int x, int y) : Enemy(x, y) {
...
void Boss_Head2::Update() {
	...
	case Boss_Head2::state::LAUNCH:
		...
		break;
	case Boss_Head2::state::ATTACK:
		currentAnim = &attackAnim;
		attackAnim.Update();
		attackPath.Update();
		position = spawnPos + attackPath.GetRelativePosition();
		break;
	case Boss_Head2::state::DEATH:
...
void Boss_Head2::OnCollision(Collider* col) {

}

void Boss_Head2::SetToDelete() {
